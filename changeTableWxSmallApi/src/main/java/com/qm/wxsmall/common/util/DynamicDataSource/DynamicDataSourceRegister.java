package com.qm.wxsmall.common.util.DynamicDataSource;
    ...
    public DataSource buildDataSource(Map<String, Object> dsMap) {
        try {
            ...
            DataSourceBuilder factory = DataSourceBuilder.create()
                    ...
                    .password(password)
                    .type(dataSourceType);
            DataSource source =  factory.build();
            if (type.toString().contains("DruidDataSource")) {
                DruidDataSource s = (DruidDataSource)source;
                s.setKeepAlive(true);
            }
            return source;
