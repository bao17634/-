...
import com.qm.volkswagenChina.demo.HTMLTOExcel;
import com.qm.volkswagenChina.demo.ocr.APPCodeDemo;
...
//            importExcel.print(json,"aaaa");
    ...
    @RequestMapping(value = "/wxSmall/excel/importExcel")
    @ResponseBody
